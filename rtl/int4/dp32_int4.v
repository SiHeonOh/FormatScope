// INT4 32-element dot-product accumulator (build-plan.md S5.1, S5.3).
// Same datapath as dp32_int8 with W = 4: the stages are shared from adder_tree.v.
module dp32_int4 #(
  ...
  input  wire [127:0] a_flat,         // 32 two's-complement codes, element 0 in the LSBs
